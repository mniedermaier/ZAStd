...
export const TUTORIAL_HINTS: { step: number; text: string; trigger: string; subtext?: string; phase?: string }[] = [
  ...
  { step: 2, text: 'Build 3+ towers to extend the maze path', subtext: 'Longer paths = more shots from your towers. The path must always remain open!', trigger: 'towers_3' },
  { step: 3, text: 'Send Wave 1! Press Space or click Send Wave.', subtext: 'Enemies walk from green spawn to red exit. If they reach the exit, you lose lives (30 total).', trigger: 'wave_started' },
  { step: 4, text: 'Watch your towers attack! Wait for all enemies to die.', subtext: 'Enemies killed give gold. You earn income each wave: 40 + 8 per wave.', trigger: 'wave_1_complete' },
  { step: 5, text: 'Select your tower and press Q to upgrade it', subtext: 'Click a tower then press Q. Upgrades boost damage +20%, range +10%. Max level 4.', trigger: 'tower_upgraded' },
  { step: 6, text: 'Try selling a tower — select it and press E', subtext: 'Selling returns 70% of gold invested. Useful for rearranging your maze.', trigger: 'tower_sold' },
  { step: 7, text: 'Send Wave 2! Press Space to start.', subtext: 'You earn gold per wave plus interest on savings each wave!', trigger: 'wave_2_complete' },
  { step: 8, text: 'Send Wave 3! Fast enemies — twice the speed!', subtext: 'Build a Frost Trap (press 3, 50g) to slow them down. Press Space to start!', trigger: 'wave_3_complete' },
  ...
  { step: 10, text: 'Send Wave 4 — see magic damage in action! Press Space.', subtext: 'Common towers deal physical damage. Governor towers deal magic damage.', trigger: 'wave_4_complete' },
  { step: 11, phase: 'Economy', text: 'Send Wave 5! Tank enemies — very high HP, very slow.', subtext: 'Focus fire with many towers. You earn Lumber every 5 waves for tech upgrades!', trigger: 'wave_5_complete' },
  ...
  { step: 13, phase: 'Damage Types', text: 'Send Wave 6! Armored enemies resist 50% physical damage!', subtext: 'Use Fire towers (magic damage) against them. Mix damage types!', trigger: 'wave_6_complete' },
  { step: 14, text: 'Send Wave 7! Magic Resist enemies halve magic damage!', subtext: 'Use Arrow and Cannon (physical) against these. A good defense needs both!', trigger: 'wave_7_complete' },
  ...
  { step: 16, phase: 'Special Enemies', text: 'Send Wave 8! Flying enemies ignore your maze!', subtext: 'They fly direct to exit. Place towers near their flight path. Press Space!', trigger: 'wave_8_complete' },
  { step: 17, text: 'Send Wave 9! Healers regenerate HP — kill them first.', subtext: 'High burst damage counters healing. Poison reduces healing by 50%.', trigger: 'wave_9_complete' },
  ...
  { step: 19, text: 'Send Wave 10! Berserkers get faster with every hit!', subtext: 'Kill them quickly. High damage towers like Cannon and Inferno work best.', trigger: 'wave_10_complete' },
  ...
  { step: 21, text: 'Send Wave 11! Splitters break into 2 enemies on death!', subtext: 'Splash damage towers handle splits well. Press Space!', trigger: 'wave_11_complete' },
  { step: 22, phase: 'Boss Fight', text: 'Send Wave 12 — BOSS WAVE! High HP, armor AND resist!', subtext: 'Use everything: abilities, upgrades, both damage types. Final test!', trigger: 'wave_12_complete' },
